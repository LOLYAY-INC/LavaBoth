...
public class TrackPausedEvent extends TrackEvent {
    public TrackPausedEvent(MusicAudioTrack track, AbstractPlayer player, AbstractPlayerManager playerManager) {
